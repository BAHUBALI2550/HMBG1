...
class Login_PageState extends State<Login_Page> {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                        ...
                        width: 280,
                        child: Text('Forget Password ?',textAlign: TextAlign.left,style: TextStyle(color: Colors.redAccent,fontWeight: FontWeight.bold,fontStyle: FontStyle.italic,fontSize: 20),)),
                    SizedBox(
                      height: 15,
                    ),
                      ...
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>SignUp()));
                          ...
                          child: Container(
                              ...
                              child: Padding(
                                ...
                                child: Text('Sign Up',style: TextStyle(color: Colors.redAccent,fontWeight: FontWeight.bold,fontSize: 20),),
                              )),
                        ),
                        SizedBox(
                          width: 19,
  ...
  void wheretogo1() {
    if(controller1.toString()==user&&controller2.toString()==passw){
